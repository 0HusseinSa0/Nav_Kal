  ...
  const hardware_interface::HardwareInfo & info)
{
  ...
  for (const hardware_interface::ComponentInfo & joint : info_.joints)
  {
    ...
    {
      RCLCPP_INFO(rclcpp::get_logger("DiffDriveArduinoHardware"), "REACHED HERREEE ! YA 7REMEEEEEE 1");
      RCLCPP_INFO(rclcpp::get_logger("DiffDriveArduinoHardware"), "Device name: %s", joint.state_interfaces[0].name.c_str());
      RCLCPP_INFO(rclcpp::get_logger("DiffDriveArduinoHardware"), "Device name: %s", joint.state_interfaces[1].name.c_str());
